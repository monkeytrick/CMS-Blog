...
if(isset($_GET['delete'])) {
  ...
  $user_id = secure_string(mysqli_escape_string($connection, $_GET['delete']));
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              $get_posts = secure_string(" SELECT * FROM posts ");
    ...
    <div class="row">
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <?php
                $comment_query = secure_string(" SELECT * FROM comments ");
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <?php
                $post_query = secure_string(" SELECT * FROM posts ");
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <?php
                $users_query = secure_string(" SELECT * FROM users ");
    ...
    <div class="content">
      ...
      <?php         
              ...
              switch($source) {
                ...
                default:
                include "include/view-users.php";
                break; 
