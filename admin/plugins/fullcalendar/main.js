    ...
    */
    ...
    function getRelevantEvents(eventStore, instanceId) {
        ...
        if (instance) {
            ...
            var ore = filterEventStoreDefs(eventStore, function (lookDef) {
                return isEventDefsGrouped(def_1, lookDef);
            });
            // add the original
            // TODO: wish we could use eventTupleToStore or something like it
            ore.defs[def_1.defId] = def_1;
            ore.instances[instance.instanceId] = instance;
            return ore;
        }
    ...
    var Calendar = /** @class */ (function () {
        ...
        Calendar.prototype.dispatch = function (action) {
            ...
            if (!this.isReducing) {
                ...
                var ate = this.state;
                this.isReducing = false;
                if (!oldState.loadingLevel && ate.loadingLevel) {
                    this.publiclyTrigger('loading', [true]);
                }
                else if (oldState.loadingLevel && !ate.loadingLevel) {
                    this.publiclyTrigger('loading', [false]);
                }
                var view = this.component && this.component.view;
                if (oldState.eventStore !== ate.eventStore) {
                    if (oldState.eventStore) {
                        this.isEventsUpdated = true;
                    }
                }
                if (oldState.dateProfile !== ate.dateProfile) {
                ...
                if (oldState.viewType !== ate.viewType) {
